...
class StructuredRequest(BaseModel):
    ...
    members: list[str] = Field(default_factory=list, description = "참여 인원")
    priority: str | None = Field(default = None, description = "할 일우선 순위")
...
def week02_system_prompt() -> str:
    ...
    return join_system_prompt([
        *week02_prompt_parts(),
        ...
        "personal_create_schedule tool 결과 JSON을 받았다면 그 안의 created_schedule 필드 값을 읽어 "
