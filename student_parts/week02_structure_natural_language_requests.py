...
def extract_structured_request(text: str) -> StructuredRequest:
    ...
    result = structured_model.invoke([ {"role": "system", "content": join_system_prompt(week02_prompt_parts())}, {"role": "user", "content": text} ])
...
def week02_prompt_parts() -> list[str]:
    ...
    return [
        *week01_prompt_parts(),
        ...
        "week 1 도구(예: personal_create_schedule)를 호출하여 반환된 json 있는 경우, 동일한 도구를 중복해서 다시 호출하지 말고 반환된 payload를 읽어서 structured_response로 만든다.",
