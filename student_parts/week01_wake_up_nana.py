...
def personal_create_schedule(
    ...
    start_time: str,
    end_time: str = "미정",
    attendees: list[str] | None = None,from __future__ import annotations
...
def personal_create_schedule(
    ...
    return _json({"ok": True, "schedule": schedule})
...
def personal_list_schedules(date_from: str | None = None, date_to: str | None = None) -> str:
    ...
    return _json({"ok": True, "schedules": PERSONAL_SCHEDULES})
