...
SQLITE_MEMORY_PROMPT = ( 
    "너는 SQLite DB에 일정을 저장하고 조회할 수 있습니다."
    "새 대화에서도 저장된 일정은 유지됩니다."
    "사용자가 일정을 물어보면 personal_list_saved_schedules로 조회하세요."
)

# TODO: 자연어 구조화 → SQLite 저장과 조회/수정/삭제 tool 호출 순서를 안내하는 규칙을 작성하세요.
WEEK03_TOOL_CALL_PROMPT = (
    "일정 저장 순서: extract_schedule_request → save_structured_request. "
    "일정 삭제 순서: personal_list_saved_schedules로 후보 확인 → personal_delete_saved_schedules. "
    "조회는 personal_list_saved_schedules, 단건은 get_saved_request를 사용하세요."
)
